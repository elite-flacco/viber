...
const getModuleColor = (type: ModuleType) => {
  switch (type) {
    case 'prd': return 'border-blue-200 bg-blue-50';
    case 'roadmap': return 'border-green-200 bg-green-50';
    case 'tasks': return 'border-orange-200 bg-orange-50';
    case 'scratchpad': return 'border-yellow-200 bg-yellow-50';
    case 'prompts': return 'border-purple-200 bg-purple-50';
    case 'secrets': return 'border-red-200 bg-red-50';
...
export const ModuleContainer: React.FC<ModuleContainerProps> = ({
  ...
  return (
    <div className={`h-full bg-white border-2 rounded-lg shadow-sm hover:shadow-md transition-shadow ${getModuleColor(type)}`}>
      {/* Header */}
